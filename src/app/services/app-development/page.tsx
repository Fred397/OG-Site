...
import { ArrowUpRight, CheckCircle2, Smartphone, Shield, WifiOff } from "lucide-react";

export const metadata = {
  title: "App Development",
  description:
    "Native iOS, Android, and cross-platform React Native and Flutter mobile applications engineered by Opus Geeks.",
};

export default function AppDevelopmentPage() {
  const service = servicesData.find((s) => s.slug === "app-development")!;
      ...
      <Container size="wide">
        ...
        <div className="rounded-3xl p-8 sm:p-14 mb-16 bg-slate-900 border border-slate-800 shadow-xl">
          <div className="max-w-3xl">
            <h3 className="text-2xl sm:text-3xl font-bold text-slate-100 mb-6">
              Responsive mobile apps built for real people and daily use.
            </h3>
            <p className="text-base sm:text-lg text-slate-300 leading-relaxed mb-8">
              {service.description}
            </p>
            <Button href="/contact" variant="primary" size="lg">
              <span>Discuss Mobile App</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 flex flex-col gap-4 shadow-sm hover:border-slate-700 transition-colors">
            ...
            <h4 className="text-xl font-bold text-slate-100">Native & Cross-Platform</h4>
            <p className="text-sm text-slate-400 leading-relaxed">
              Pragmatic approaches utilizing Swift/Kotlin or React Native/Flutter to maximize performance and maintainability.
            </p>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 flex flex-col gap-4 shadow-sm hover:border-slate-700 transition-colors">
            ...
            <h4 className="text-xl font-bold text-slate-100">Offline-First Engine</h4>
            <p className="text-sm text-slate-400 leading-relaxed">
              Local SQLite caching with background conflict resolution and sync when network connection drops.
            </p>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 flex flex-col gap-4 shadow-sm hover:border-slate-700 transition-colors">
            ...
            <h4 className="text-xl font-bold text-slate-100">Security & Biometrics</h4>
            <p className="text-sm text-slate-400 leading-relaxed">
              Secure Enclave integration, FaceID/TouchID, encrypted storage, and reliable authentication flows.
            </p>
          </div>
        </div>
